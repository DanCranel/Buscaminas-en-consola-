...
import POO.Examen.buscaminas.modelo.Casilla;
import POO.Examen.buscaminas.modelo.Juego;
import POO.Examen.buscaminas.modelo.Tablero;

/**
 * Clase VistaConsola
 * Implementa la "Vista" del patrón MVC utilizando la consola.
 * No contiene lógica de negocio, solo presentación y lectura de datos.
 */
